...
MySQL - 5.7.26-log : Database - sw_shop
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sw_shop` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;

USE `sw_shop`;

/*Table structure for table `hd_admin` */
