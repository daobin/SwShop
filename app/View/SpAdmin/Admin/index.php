<?php
\App\Helper\TemplateHelper::widget('sp_admin', 'header', ['add_url' => '/spadmin/admin/0', 'timestamp' => $timestamp ?? '']);
?>
    ...
    <script>
        layui.use(['table'], function () {
            layui.table.render({
                ...
                cols: [
                    [
                        {field: 'account', title: '管理员', align: 'center'},
                ...
                switch (obj.event) {
                    case 'edit':
                        let layer_idx = layer.open({
                            ...
                            closeBtn: 0,
                            skin: 'hd-open-edit',
                            content: '/spadmin/admin/' + obj.data.admin_id
                        });
