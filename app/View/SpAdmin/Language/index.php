<?php
\App\Helper\TemplateHelper::widget('sp_admin', 'header', ['add_url' => '/spadmin/language/0', 'timestamp' => $timestamp ?? '']);
?>
    <div class="layui-fluid hd-padding-top60">
        <table id="lang_list" lay-filter="opt"></table>
    </div>
    ...
    <script>
        layui.use(['table'], function () {
            layui.table.render({
                ...
                cols: [
                    [
                        {field: 'language_name', title: '语言名称', align: 'center'},
                        {field: 'language_code', title: '语言编码', align: 'center'},
                ...
                switch (obj.event) {
                    case 'edit':
                        let layer_idx = layer.open({
                            ...
                            title: '编辑',
                            skin: 'hd-open-edit',
                            content: '/spadmin/language/' + obj.data.language_code
                        });
                    ...
                    case 'delete':
                        layer.confirm('确定删除该项？', open_ask_cfg, function (idx) {
                            ...
                            $.ajax({
                                type: 'post',
                                url: '/spadmin/language/delete',
                                data: {
                                    code: obj.data.language_code,
