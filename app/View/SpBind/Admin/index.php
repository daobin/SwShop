<?php
\App\Helper\TemplateHelper::widget('sp_bind', 'header', ['add_url' => '/spbind/admin/0', 'timestamp' => $timestamp ?? '']);
?>
                ...
                switch (obj.event) {
                    case 'edit':
                        let layer_idx = layer.open({
                            ...
                            closeBtn: 0,
                            skin: 'hd-open-edit',
                            content: '/spbind/admin/' + obj.data.admin_id
                        });
