...
class CategoryController extends Controller
{
    ...
    public function detail()
    {
        ...
        if ($this->request->isPost) {
            ...
            $defaultLangCode = ConfigHelper::getLangCodes();
            $defaultLangCode = reset($defaultLangCode);
            ...
            if ($prodBiz->saveCategory($cateData, $cateDescData) > 0) {
        ...
        $cateTreeList = [
            [
                ...
                'children' => $prodBiz->getCategoryTree($this->request->shop_id, 0, 'zh', $cateId)
            ]
        ];
        ...
        return $this->render([
            ...
            'lang_codes' => ConfigHelper::getLangCodes(),
